...
const hwCommunityConferences = structuredClone(devrelConferences);
hwCommunityConferences[0].items = [
  ...hwCommunityConferences[0].items.slice(0, 5),
  ...hwCommunityConferences[0].items.slice(6),
];
